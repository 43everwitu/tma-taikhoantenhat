...
const GROUPS: Group[] = [
  {
    ...
    fields: [
      ...
      { key: 'support_url', label: 'URL hỗ trợ (nút trên mini app)', type: 'url',
        description: 'Link Messenger / Zalo / chat — hiện ở nút hỗ trợ trên thanh nav. Trống để ẩn.',
        placeholder: 'https://m.me/yourshop hoặc https://zalo.me/123' },
      { key: 'backorder_wait_message', label: 'Tin nhắn chờ đơn đặt trước', type: 'textarea',
        description: 'Gửi cho khách sau khi thanh toán đơn có biến thể đặt trước (backorder).',
        placeholder: 'Đơn này được giao thủ công, shop sẽ xử lý trong ít phút.' },
