...
const productService = {
     ...
     */
    getAll() {
        // Global sort_order — matches admin /products list and customer /san-pham.
        // Admin can drag products to any position regardless of category, and
        // the bot menu reflects that exact ordering.
        return db.prepare(`
      SELECT p.*,
